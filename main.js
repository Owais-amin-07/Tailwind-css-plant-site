...
const scrollUp = () => {
    scrollUpBtn = document.getElementById("scrol-up");
...
sr.reveal('.about_item1_content, .about_item2_img', {origin: "right"});
sr.reveal('.about_item2_content, .about_item1_img', {origin: "left"});
